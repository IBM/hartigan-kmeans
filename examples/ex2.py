...
for algorithm_name in ['lloyd_kmeans', 'hartigan_kmeans']:
    ...
    if algorithm_name is 'lloyd_kmeans':
        algorithm = KMeans(n_clusters=n_clusters, n_init=n_init, max_iter=15, algorithm='full')
    elif algorithm_name is 'hartigan_kmeans':
        algorithm = HKMeans(n_clusters=n_clusters, n_init=n_init, n_jobs=-1, max_iter=15)
    else:
